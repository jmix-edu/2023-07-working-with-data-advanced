...
public interface DeveloperRole {
    ...
    @EntityAttributePolicy(entityClass = Project.class, attributes = {"id", "totalEstimatedEfforts", "name", "startDate", "endDate", "manager", "status", "projectLabels", "participants", "version", "createdBy", "createdDate", "lastModifiedBy", "lastModifiedDate", "deletedBy", "deletedDate"}, action = EntityAttributePolicyAction.VIEW)
